...
{
    public class VsechnyNeohod : IStrategie
    { // Implementace strategie nalezení (jedné) cesty, neuvažující ohodnocení. 
      ...
      // a v nich některé dále "jemně" přizpůsobovat.
        ...
        public virtual void Nastav() {} // není třeba dělat nic
        ...
        // graf nesmí obsahovat násobné hrany (nemají smysl, neuvažje se ohodnocení)
        ...
        // vlastnost řídící předčasné ukončení prohledávání (strategie vyžaduje všechny cesty -> není potřeba předčasně ukončovat prohledávání)
